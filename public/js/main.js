...
btn_eliminar2.addEventListener('click', function (e) {
  alert('eliminando...');
});
...
function pintarCargos(json) {
  var tabla = document.querySelector('#tbody_empleado_cargo');
  tabla.innerHTML = '';
  ...
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      ...
      input.name = "id_cargo";
      input.value = fila.id;
      var txt2 = document.createTextNode(fila.id);
      var txt3 = document.createTextNode(fila.cargo);
      var txt4 = document.createTextNode(fila.descripcion);
...
/******/ 	__webpack_require__.O(undefined, ["css/components"], () => (__webpack_require__("./resources/js/main.js")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/components"], () => (__webpack_require__("./resources/css/components.css")))
