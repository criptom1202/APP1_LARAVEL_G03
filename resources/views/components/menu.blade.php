<div {{ $attributes->merge(['class' => 'font-bold']) }}>
    <nav>
        <ul>
            ...
            <li class="pl-10 py-3 hover:bg-red-800 flex flex-row"><div class="px-5"><i class="fas fa-users"></i></div><a href="#">Cargos</a></li>
            <li class="pl-10 py-3 hover:bg-red-800 flex flex-row"><div class="px-5"><i class="fas fa-people-arrows"></i></div><a href="#">Empleados</a></li>
